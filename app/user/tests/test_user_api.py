...
class PublicUserApiTests(TestCase):
    ...
    def test_password_too_short_error(self):
        """Test an error is returned when password is less 5 chars."""
    ...
    def test_create_token_bad_credentials(self):
        ...
        payload = {"email": "test@example.com", "passwrod": "badpass"}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_email_not_found(self):
        ...
        payload = {"email": "test@example.com", "password": "paswordtest123"}
        res = self.client.post(TOKEN_URL, payload)
...
class PrivateUserAPITests(TestCase):
    ...
    def test_update_user_profile(self):
        """Test updating user profile authenticated user."""
        payload = {
            "name": "Updated name",
